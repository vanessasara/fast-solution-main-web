...
export default function TravelAgencyTicketingPage() {
  const service = getServiceBySlug('travel-agency-ticketing');

  if (!service) {
    return <div>Service not found</div>;
  }

  const relatedServices = formatRelatedServices('travel-agency-ticketing', 3);
