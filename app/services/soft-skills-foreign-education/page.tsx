...
export default function SoftSkillsForeignEducationPage() {
  const service = getServiceBySlug('soft-skills-foreign-education');

  if (!service) {
    return <div>Service not found</div>;
  }

  const relatedServices = formatRelatedServices('soft-skills-foreign-education', 3);
