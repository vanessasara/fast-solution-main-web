...
export default function HospitalityTourismAppPage() {
  const service = getServiceBySlug('hospitality-tourism-app');

  if (!service) {
    return <div>Service not found</div>;
  }

  const relatedServices = formatRelatedServices('hospitality-tourism-app', 3);
